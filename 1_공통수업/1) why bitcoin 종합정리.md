...
> **[보강 예정]** 사이퍼펑크 운동의 역사 및 비트코인 이전의 디지털 현금 시도들(DigiCash, b-money, HashCash 등)은 추후 강의 내용을 바탕으로 보강 예정.
...
> **[보강 예정]** 비트코인이 어떻게 절대적 희소성(S2F)을 달성하는지(2100만 개 한정, 반감기 메커니즘), 어떻게 탈중앙화와 검열 저항을 구현하는지는 추후 기술 파트 강의 내용을 바탕으로 보강 예정.
